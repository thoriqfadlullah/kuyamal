  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="dashboard.html" class="brand-link">
      ...
      <span class="brand-text font-weight-light">KUYAMAL</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="{{ asset('images/logoka.png') }}" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
          <a href="/admin" class="d-block">Pengajuan</a>
        </div>
      </div>
